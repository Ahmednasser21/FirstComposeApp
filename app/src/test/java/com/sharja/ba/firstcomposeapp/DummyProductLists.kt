...
object DummyProductLists {
    ...
    fun getDummyLocalProductsList() = arrayListOf(
        LocalProduct(0,"t0","d0","p0","0","b0","i0",true),
        LocalProduct(1,"t1","d1","p1","1","b1","i1",false),
        LocalProduct(2,"t2","d2","p2","2","b2","i2",false),
        LocalProduct(3,"t3","d3","p3","3","b3","i3",false),
        LocalProduct(4,"t4","d4","p4","4","b4","i4",false),
        LocalProduct(5,"t5","d5","p5","5","b5","i5",false),
        LocalProduct(6,"t6","d6","p6","6","b6","i6",false),
        LocalProduct(7,"t7","d7","p7","7","b7","i7",false),
